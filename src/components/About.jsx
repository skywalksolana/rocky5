    ...
    return (
        ...
        <Container>
            <Row className="align-items-center">
                ...
                Now, HOSCAT is no longer just a coin—it’s a movement. A fluffy rebellion. A paw-sitive force of financial chaos led by the internet’s chunkiest general.
So remember: In fluff we trust. In snacks we invest. And with HOSCAT, we moon.
                </p>
